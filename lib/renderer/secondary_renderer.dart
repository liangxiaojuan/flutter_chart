    ...
    switch (state) {
      case SecondaryState.MACD:
        children = [
          ...
          if (data.dif != 0)
            TextSpan(text: "DIF:${format(data.dif)}    ", style: getTextStyle(ChartColors.difColor)),
          if (data.dea != 0)
            TextSpan(text: "DEA:${format(data.dea)}    ", style: getTextStyle(ChartColors.deaColor)),
        ];
        break;
      case SecondaryState.KDJ:
        children = [
          ...
          if (data.dif != 0)
            TextSpan(text: "D:${format(data.d)}    ", style: getTextStyle(ChartColors.dColor)),
          if (data.dea != 0)
            TextSpan(text: "J:${format(data.j)}    ", style: getTextStyle(ChartColors.jColor)),
        ];
        break;
      case SecondaryState.RSI:
        children = [
          TextSpan(text: "RSI(14):${format(data.rsi)}    ", style: getTextStyle(ChartColors.rsiColor)),
        ];
        break;
      case SecondaryState.WR:
        children = [
          TextSpan(text: "WR(14):${format(data.r)}    ", style: getTextStyle(ChartColors.rsiColor)),
        ];
        break;
      default:
        break;
